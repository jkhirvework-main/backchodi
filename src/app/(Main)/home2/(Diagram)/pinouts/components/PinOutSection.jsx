            ...
            <Box sx={{pt: 1}}>
                ...
                <Card elevation={0} variant='outlined' sx={{ mt: 4, borderRadius: 2, mb: 8 }}>
                    <Box display={'flex'} justifyContent={'center'} alignItems={'center'} >
                        ...
                        <Box sx={{ p: 2 }}>
                            <TextField onChange={handlerSearch} value={search} size='small' placeholder='search' InputProps={{ endAdornment: (<InputAdornment position="end"   ><IconButton ><Search /></IconButton></InputAdornment>) }} />
                        </Box>
                    </Box>
